...
if __name__ == '__main__':
    ...
    while True:
        ...
        print(
            "FR q:",
            round(state.motorState[d['FR_0']].q, 4),
            round(state.motorState[d['FR_1']].q, 4),
            round(state.motorState[d['FR_2']].q, 4),
            "| IMU rpy:",
            round(state.imu.rpy[0], 4),
            round(state.imu.rpy[1], 4),
            round(state.imu.rpy[2], 4),
        )
